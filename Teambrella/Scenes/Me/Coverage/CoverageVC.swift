...
class CoverageVC: UIViewController, Routable {
    ...
    @IBOutlet var coverageLabel: UILabel!
    ...
    override func viewDidLoad() {
        ...
        coverageLabel.text                            = String(coverage)
        setImage(for: coverage)
        fundWalletButton.isEnabled               = coverage != 100
        fundWalletButton.alpha                   = coverage == 100 ? 0.3 : 1
