...
class JoinTeamTermsCell: UICollectionViewCell, XIBInitableCell {
    ...
    override func awakeFromNib() {
        super.awakeFromNib()
        headerLabel.text = "Team.JoinTeamVC.TermsCell.headerLabel".localized
        ...
        nonBoldString = "Team.JoinTeamVC.TermsCell.nonBold".localized
        boldString = "Team.JoinTeamVC.TermsCell.bold".localized
